...
const DynamicComponent3 = dynamic(() => import('./cards/ASR'));
    ...
    return(
        <>
                ...
                animate='show'>
                    ...
                    <div>
                        <motion.li 
                         className="pb-2 hover:text-2xl hover:ease-out hover:duration-300"   
                         variants={item}>
                            <Link href="#" onClick={() => handleLinkClick('ASR')}>Automated Speech Recognition</Link>
                        </motion.li>
                    </div>
            ...
            <div className='lg:ml-40 lg:mt-32 lg:absolute  lg:inset-x-2/4 lg:left-0 lg:top-20'>
                ...
                {selectedComponent === 'ASR' && <DynamicComponent3 />}
