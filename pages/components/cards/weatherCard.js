    ...
    return(
        ...
        <div className="lg:pl-5 lg:-ml-3 lg:border-4 lg:border-l-black lg:border-r-0 lg:border-t-0 lg:border-b-0 lg:dark:border-l-champagne">
            ...
            <div className="pt-4">
                ...
                href="https://god-lang.github.io/weather_app-main/" target="_blank" rel="noreferrer">View Site</a>|
                <a 
                className="underline font-gloock pl-2"
                href="https://github.com/GOD-lang/weather_app-main" target="_blank" rel="noreferrer">Github</a>
            </div>
        </div>
        </motion.div>
    );
